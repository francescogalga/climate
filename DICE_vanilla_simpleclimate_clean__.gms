...
* to change if we want to use or not cost benefit analysis (finding the minimum of damage cost + abatement cost)
** Preferences
...
VARIABLES
        ...
        CCA(t)          Cumulative carbon emissions (GTC)
...
*Climate
 tatmeq(t+1)..        TATM(t+1)      =E=  CCATOT(t+1)*tcre/1000 + 0.75*forcoth(t+1);
...
execute_unload "resultsCBA.gdx", TATM.L,Y.L,DAMFRAC.L,CPC.L,cprice.L,MIU.L,scc,RI.l,E.l, L, sigma;
execute_unload "resultsCBA.xls", TATM.L;
*export to xls
...
execute_unload "resultsCBA_.gdx"
*export to xls
